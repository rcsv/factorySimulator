...
public class Logger {
	...
	public enum VerboseLevel {
		 ...
		 * およそどうでもいい情報はさっさと切ってしまいましょう。どうしても興味がわく場合は、
		 * Logger.lv = Logger.VerboseLevel.Debug とかにします。
		 */
		Debug,
		...
		/**
		 * Notice レベルになると、この情報を見た何らかの人、機械、その他のインスタンスが判断し、
		 * 行動を変更します。この情報を直接見て動くような仕組みにするつもりはないので、あくまで
		 * シミュレーターを眺めている人用の情報提供です。
		 */
		Notice,
		 ...
		 * シミュレーター内のあらゆるインスタンスはこれが発生したら「慌てる」様に振る舞う必要が
		 * ありそうです。
		 */
		Warn,
		
		/**
		 * Debug レベルではありませんが、シミュレーターの不具合で、意図しない振る舞いが発生した
		 * 場合に表示します。
		 */
		Error,
		
		/**
		 * Debug レベルではありませんが、シミュレーターに復旧できない不具合が生じた時、異常終了
		 * と伴に表示させるべきレベルのものです。
		 */
		Abend,
